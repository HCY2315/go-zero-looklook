...
const file_usercenter_proto_rawDesc = "" +
	...
	"\bauthType\x18\x02 \x01(\tR\bauthType\"B\n" +
	...
	"\vaccessToken\x18\x01 \x01(\tR\vaccessToken\x12\"\n" +
	"\faccessExpire\x18\x02 \x01(\x03R\faccessExpire\x12\"\n" +
	"\frefreshAfter\x18\x03 \x01(\x03R\frefreshAfter2\xf9\x02\n" +
	"\n" +
	"usercenter\x12$\n" +
	...
	"\x14getUserAuthByAuthKey\x12\x1b.pb.GetUserAuthByAuthKeyReq\x1a\x1c.pb.GetUserAuthByAuthKeyResp\x12M\n" +
	"\x13getUserAuthByUserId\x12\x1a.pb.GetUserAuthByUserIdReq\x1a\x1a.pb.GetUserAuthyUserIdResp\x12<\n" +
